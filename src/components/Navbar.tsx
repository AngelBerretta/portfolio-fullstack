...
const navLinks = [
  { label: 'Inicio',    href: '***REMOVED***hero',     icon: <Home      size={16} /> },
  { label: 'Sobre mí', href: '***REMOVED***about',    icon: <User      size={16} /> },
  { label: 'Skills',   href: '***REMOVED***skills',   icon: <Zap       size={16} /> },
  { label: 'Proyectos',href: '***REMOVED***projects', icon: <FolderOpen size={16} /> },
  { label: 'Contacto', href: '***REMOVED***contact',  icon: <Mail      size={16} /> },
];
    ...
    <>
      ...
      >
        <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
          ...
          {/* ── Logo ─────────────────────────────────────────────────── */}
          <button
            onClick={() => handleNav('***REMOVED***hero')}
