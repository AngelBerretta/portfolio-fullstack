  ...
  return (
    ...
    >
      ...
      <div className="relative aspect-video overflow-hidden [background:var(--bg-surface)]">
        ...
        />
        <div className="absolute inset-0 bg-gradient-to-t from-[***REMOVED***050816] via-[***REMOVED***050816]/20 to-transparent" />
...
const upcomingConfig: Record<string, {
  ...
  'BookWise': {
    ...
    accentColor: '***REMOVED***8B5CF6',
  },
  'MindMap AI': {
    initials: 'MM',
    gradient: 'from-cyan-500/20 via-blue-500/10 to-transparent',
    glowColor: 'rgba(6, 182, 212, 0.3)',
    accentColor: '***REMOVED***06B6D4',
  },
};
