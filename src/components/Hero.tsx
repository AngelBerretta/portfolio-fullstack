...
const ArgentinaFlag = () => (
  <svg
    ...
    role="img"
  >
    <rect width="27" height="6" fill="***REMOVED***74ACDF" />
    <rect y="6" width="27" height="6" fill="***REMOVED***FFFFFF" />
    <rect y="12" width="27" height="6" fill="***REMOVED***74ACDF" />
    <circle cx="13.5" cy="9" r="3.5" fill="***REMOVED***F6B40E" />
  </svg>
);
