...
function renderContactEmailHtml({
  ...
  return `
    <div style="font-family: system-ui, sans-serif, Arial; font-size: 14px; max-width: 600px; margin: 0 auto; background-color: ***REMOVED***ffffff; border-radius: 8px; overflow: hidden; border: 1px solid ***REMOVED***e2e8f0;">

      <!-- Header -->
      <div style="background: linear-gradient(135deg, ***REMOVED***1e3a5f 0%, ***REMOVED***2563eb 100%); padding: 28px 32px;">
        <div style="color: ***REMOVED***ffffff; font-size: 20px; font-weight: 700; margin-bottom: 4px;">
          📬 Nuevo mensaje desde tu portfolio
        </div>
        <div style="color: ***REMOVED***93c5fd; font-size: 13px;">
      ...
      <div style="padding: 28px 32px;">
        <!-- Info del remitente -->
        <table role="presentation" style="width: 100%; margin-bottom: 24px; background-color: ***REMOVED***f8faff; border-radius: 8px; border: 1px solid ***REMOVED***e0e7ff; padding: 16px;">
          <tbody>
            <tr>
              <td style="vertical-align: middle; width: 56px;">
                <div style="width: 48px; height: 48px; background: linear-gradient(135deg, ***REMOVED***2563eb, ***REMOVED***60a5fa); border-radius: 12px; display: flex; align-items: center; justify-content: center; font-size: 22px; text-align: center; line-height: 48px;">
                  👤
                </div>
              </td>
              <td style="vertical-align: middle; padding-left: 14px;">
                <div style="color: ***REMOVED***1e293b; font-size: 16px; font-weight: 700;">${safeName}</div>
                <div style="color: ***REMOVED***2563eb; font-size: 13px; margin-top: 2px;">${safeEmail}</div>
                <div style="color: ***REMOVED***94a3b8; font-size: 12px; margin-top: 2px;">${time}</div>
              </td>
            </tr>
          </tbody>
        </table>
        ...
        <div style="margin-bottom: 16px;">
          <div style="color: ***REMOVED***64748b; font-size: 11px; font-weight: 700; text-transform: uppercase; letter-spacing: 0.08em; margin-bottom: 6px;">
            Asunto
          </div>
          <div style="color: ***REMOVED***1e293b; font-size: 15px; font-weight: 600; padding: 10px 14px; background-color: ***REMOVED***f1f5f9; border-radius: 6px; border-left: 3px solid ***REMOVED***2563eb;">
            ${safeSubject}
          </div>
        </div>
        ...
        <div style="margin-bottom: 24px;">
          ...
          <div style="color: ***REMOVED***334155; font-size: 15px; line-height: 1.7; padding: 16px; background-color: ***REMOVED***f8faff; border-radius: 6px; border: 1px solid ***REMOVED***e0e7ff; white-space: pre-wrap;">
            ${safeMessage}
          </div>
        </div>
        ...
        <div style="text-align: center; margin-bottom: 8px;">
          <a href="mailto:${safeEmail}"
            style="display: inline-block; background: linear-gradient(135deg, ***REMOVED***2563eb, ***REMOVED***60a5fa); color: ***REMOVED***ffffff; font-size: 14px; font-weight: 700; text-decoration: none; padding: 12px 28px; border-radius: 8px;">
      ...
      <!-- Footer -->
      <div style="padding: 16px 32px; background-color: ***REMOVED***f8faff; border-top: 1px solid ***REMOVED***e2e8f0; text-align: center;">
        <div style="color: ***REMOVED***94a3b8; font-size: 12px;">
          Este mensaje fue enviado desde el formulario de contacto de
          <span style="color: ***REMOVED***2563eb; font-weight: 600;">angelberretta.dev</span>
        </div>
      </div>
    </div>
  `;
