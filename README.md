***REMOVED*** Angel Berretta — Portfolio Full Stack
...
***REMOVED******REMOVED*** Tabla de contenidos

- [Por qué un portfolio con backend](***REMOVED***por-qué-un-portfolio-con-backend)
- [Features](***REMOVED***features)
- [Stack tecnológico](***REMOVED***stack-tecnológico)
- [Decisión de arquitectura: contacto vía Server Action en vez de EmailJS](***REMOVED***decisión-de-arquitectura-contacto-vía-server-action-en-vez-de-emailjs)
- [Modelo de datos](***REMOVED***modelo-de-datos)
- [Estructura del proyecto](***REMOVED***estructura-del-proyecto)
- [Empezar en local](***REMOVED***empezar-en-local)
- [Variables de entorno](***REMOVED***variables-de-entorno)
- [Scripts disponibles](***REMOVED***scripts-disponibles)
- [Seguridad](***REMOVED***seguridad)
- [Roadmap](***REMOVED***roadmap)
- [Contacto](***REMOVED***contacto)

---

***REMOVED******REMOVED*** Por qué un portfolio con backend
...
***REMOVED******REMOVED******REMOVED*** Sitio público
...
***REMOVED******REMOVED******REMOVED*** Panel de administración (`/admin`)
...
***REMOVED******REMOVED*** Stack tecnológico
...
***REMOVED******REMOVED*** Decisión de arquitectura: contacto vía Server Action en vez de EmailJS
...
***REMOVED******REMOVED*** Modelo de datos
...
```
src/
├── actions/          ***REMOVED*** Server Actions (auth, contact, profile, projects, skills, tags, upload)
├── app/
│   ├── admin/        ***REMOVED*** Panel de administración (protegido por middleware)
│   ├── api/          ***REMOVED*** Route Handlers (NextAuth, upload directo a Blob)
│   └── (resto)        ***REMOVED*** Páginas públicas
├── components/
│   ├── admin/        ***REMOVED*** Componentes exclusivos del panel
│   └── ...           ***REMOVED*** Secciones públicas (Hero, Projects, Skills, Contact, etc.)
├── context/          ***REMOVED*** ThemeContext (dark/light)
├── hooks/            ***REMOVED*** Hooks custom (useTypewriter, etc.)
├── lib/              ***REMOVED*** action-types, validations (Zod), rate-limit, db (Prisma), constants
├── types/            ***REMOVED*** Tipos compartidos + augmentación de next-auth
├── auth.ts / auth.config.ts  ***REMOVED*** Configuración de NextAuth (split edge-safe / full)
└── proxy.ts          ***REMOVED*** Middleware de protección de rutas /admin
```

---

***REMOVED******REMOVED*** Empezar en local
...
Completá `.env.local` (ver [Variables de entorno](***REMOVED***variables-de-entorno)) y después:

```bash
npx prisma migrate dev   ***REMOVED*** aplica el schema contra tu base de Postgres
npx prisma db seed       ***REMOVED*** opcional — datos iniciales
npm run dev
```
...
***REMOVED******REMOVED*** Scripts disponibles

```bash
npm run dev      ***REMOVED*** servidor de desarrollo
npm run build    ***REMOVED*** build de producción
npm run start    ***REMOVED*** levanta el build de producción
npm run lint     ***REMOVED*** ESLint
npx prisma studio        ***REMOVED*** explorar la base de datos visualmente
npx prisma migrate dev   ***REMOVED*** aplicar cambios de schema
```

---

***REMOVED******REMOVED*** Seguridad
